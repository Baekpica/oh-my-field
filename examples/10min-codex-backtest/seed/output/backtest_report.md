...
| Month | Net Return | Ending Value | Drawdown | Rebalance Cost |
|-------|------------|--------------|----------|----------------|
...
- Rebalance cost is charged only for the 2026-04 rebalance.
- Annualized volatility uses sample standard deviation of monthly net returns
