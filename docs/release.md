...
Public release is tag-driven. The release target for this branch is `v0.2.5`.
Use `0.2.5` for the patch release that makes archive packages the canonical
cross-runtime capability artifact and documents the import-first portability
lifecycle across all runtime adapters.
