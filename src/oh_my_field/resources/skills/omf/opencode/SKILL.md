...
# OMF Skill For OpenCode

Use OMF as an explicit tracking and capability packaging layer. Continue using
OpenCode for the actual task, and call OMF only to record session events,
...
1. Keep working through OpenCode normally.
...
1. `omf session start --runtime opencode --model <model> --goal "..."`
