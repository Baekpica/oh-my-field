...
# OMF Skill For Hermes

Use OMF as an explicit tracking and capability packaging layer. Continue using
Hermes for the actual task, and call OMF only to record session events,
...
1. Keep working through Hermes normally.
...
1. `omf session start --runtime hermes --model <model> --goal "..."`
