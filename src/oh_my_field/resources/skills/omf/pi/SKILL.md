---
name: omf
description: Track Pi Coding Agent work with OMF, preserve evidence, and promote reusable capabilities.
---

# OMF Skill For Pi

Use OMF as an explicit tracking and capability packaging layer. Continue using
Pi for the actual task, and call OMF only to record session events, materialize
evidence, promote reusable workflows, export capability projections, and validate
target runtime imports.
...
1. `omf session start --runtime pi --model <model> --goal "..."`
