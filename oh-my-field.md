...
- 생성된 설정은 `omf mcp serve`를 실행해 `omf_start_session`, `omf_record_event`, `omf_finish_session`, `omf_materialize_session`, `omf_promote_capability`, `omf_export_capability`, `omf_health`를 노출
